...
{
    sealed class EosCameraModelProvider : CategoryCameraModelProvider
    {
        public EosCameraModelProvider(IPlatformAdapter platformAdapter, IPlatformProvider platformProvider, IFirmwareProvider firmwareProvider)
